...
meta_total %>%
  write_tsv("../out/test_introns/table/meta_datasc_beforeQC_V5.tsv")
...
# save the plot
ggsave("../out/test_introns/plot/fixed_scatter_feature_mito_V5.pdf",width = 8,height = 4)
...
meta_total %>%
  ...
  theme(strip.background = element_blank())
# save the plot
ggsave("../out/test_introns/plot/adaptive_scatter_feature_mito_V5.pdf",width = 8,height = 4)
...
meta_total %>%
  ...
  theme(strip.background = element_blank())
# save the plot
ggsave("../out/test_introns/plot/fixed_boxplot_reads_V5.pdf",width = 6,height = 6)
...
meta_total %>%
  ...
  theme(strip.background = element_blank())
# save the plot
ggsave("../out/test_introns/plot/fixed_histo_mito_V5.pdf",width = 8,height = 4)
...
meta_total %>%
  ...
  theme(strip.background = element_blank())
# save the plot
ggsave("../out/test_introns/plot/fixed_histo_features_V5.pdf",width = 8,height = 4)
...
meta_total %>%
  ...
  theme(strip.background = element_blank())
# save the plot
ggsave("../out/test_introns/plot/fixed_histo_counts_V5.pdf",width = 8,height = 4)
...
meta_total %>%
  ...
  theme(strip.background = element_blank())
# save the plot
ggsave("../out/test_introns/plot/fixed_histo_ribo_V5.pdf",width = 8,height = 4)
...
meta_total %>%
  ...
  theme(strip.background = element_blank())
# save the plot
ggsave("../out/test_introns/plot/fixed_histo_globin_V5.pdf",width = 8,height = 4)
