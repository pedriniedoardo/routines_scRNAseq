...
# read in the data --------------------------------------------------------
data.combined <- readRDS("../out/test_introns/object/data.combined_harmonySkipIntegration_AllSoupX_01000_06000_15_V3.rds")
...
ggsave(plot = plot03a,"../out/test_introns/plot/UMAPClusterSplit_harmonySkipIntegration_AllSoupX_01000_06000_15_V3.pdf",width = 11,height = 5)

# main umap cell cycle
plot04 <- DimPlot(data.combined, reduction = "umap", group.by = "Phase",raster = T)
ggsave(plot=plot04,"../out/test_introns/plot/UMAPPhase_harmonySkipIntegration_AllSoupX_01000_06000_15_V3.pdf",width = 5,height = 4)
...
plot051 <- data2 %>%
  ...
  theme_cowplot() +
  theme(strip.background = element_blank())
ggsave(plot = plot051,"../out/test_introns/plot/UMAPRibo_harmonySkipIntegration_AllSoupX_01000_06000_15_V3.pdf",width = 5,height = 4)
ggsave(plot = plot051,"../out/test_introns/plot/UMAPRibo_harmonySkipIntegration_AllSoupX_01000_06000_15_V3.png",width = 5,height = 4,bg = "white")
...
plot052 <- data2 %>%
  ...
  theme_cowplot() +
  theme(strip.background = element_blank())
ggsave(plot = plot052,"../out/test_introns/plot/UMAPMito_harmonySkipIntegration_AllSoupX_01000_06000_15_V3.pdf",width = 5,height = 4)
ggsave(plot = plot052,"../out/test_introns/plot/UMAPMito_harmonySkipIntegration_AllSoupX_01000_06000_15_V3.png",width = 5,height = 4,bg="white")
...
plot053 <- data2 %>%
  ...
  theme_cowplot() +
  theme(strip.background = element_blank())
ggsave(plot = plot053,"../out/test_introns/plot/UMAPnCount_harmonySkipIntegration_AllSoupX_01000_06000_15_V3.pdf",width = 5,height = 4)
ggsave(plot = plot053,"../out/test_introns/plot/UMAPnCount_harmonySkipIntegration_AllSoupX_01000_06000_15_V3.png",width = 5,height = 4,bg="white")
...
plot06 <- data2 %>%
  ...
  theme_cowplot() +
  theme(strip.background = element_blank())
ggsave(plot=plot06,"../out/test_introns/plot/umapClusterSplit_harmonySkipIntegration_AllSoupX_01000_06000_15_V3.pdf",width = 11,height = 5)
ggsave(plot=plot06,"../out/test_introns/plot/umapClusterSplit_harmonySkipIntegration_AllSoupX_01000_06000_15_V3.png",width = 11,height = 5,bg="white")
...
df_summary <- df_meta %>%
  ...
  ungroup() %>%
  mutate(prop=n/tot)
write_tsv(df_summary,"../out/test_introns/table/summary_harmonySkipIntegration_AllSoupX_01000_06000_15_V3.tsv")
...
ggsave(plot=plot07,"../out/test_introns/plot/summary_harmonySkipIntegration_AllSoupX_01000_06000_15_V3.pdf",width = 7,height = 4)

plot08 <- df_summary %>%
  mutate(ID = factor(ID)) %>%
  ggplot(aes(x=RNA_snn_res.0.5,y=prop,fill=ID))+geom_col(position = "dodge")+theme_bw()+scale_fill_manual(values = col_pal)
ggsave(plot=plot08,"../out/test_introns/plot/summaryDodge_harmonySkipIntegration_AllSoupX_01000_06000_15_V3.pdf",width = 7,height = 4)
...
test_short2 <- DotPlot(data.combined, features = shortlist_features_list2, dot.scale = 8,cluster.idents = T) +
  RotatedAxis()
ggsave(plot = test_short2,"../out/test_introns/plot/Dotplot2_harmonySkipIntegration_AllSoupX_01000_06000_15_V3.pdf",width = 13,height = 5)

test_long <- DotPlot(data.combined, features = shortlist_features_list_long, dot.scale = 8,cluster.idents = T) +
  RotatedAxis()
ggsave(plot=test_long,"../out/test_introns/plot/DotplotLong_harmonySkipIntegration_AllSoupX_01000_06000_15_V3.pdf",width = 25,height = 5)
...
sobj_total_h.markers %>%
  write_tsv("../out/test_introns/table/FindAllMarkers_harmonySkipIntegration_AllSoupX_01000_06000_15_V3.tsv")

# pick the top 100 markers per cluster
sobj_total_h.markers %>%
  group_by(cluster) %>%
  slice(1:100) %>%
  write_tsv("../out/test_introns/table/FindAllMarkers_harmonySkipIntegration_AllSoupX_01000_06000_15_top100_V3.tsv")
...
sobj_total_h.markers %>%
  ...
  write_tsv("../out/test_introns/table/FindAllMarkers_harmonySkipIntegration_AllSoupX_01000_06000_15_top100_noRIBOandMT_V3.tsv")
...
ggsave("../out/test_introns/plot/Ditto_harmonySkipIntegration_AllSoupX_01000_06000_15_V3.pdf",width = 10,height = 5)
