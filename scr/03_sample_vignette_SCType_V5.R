...
# read in the dataset -----------------------------------------------------
scobj <- readRDS("../out/test_introns/object/data.combined_harmonySkipIntegration_AllSoupX_01000_06000_15_V5.rds")
...
ggsave("../out/test_introns/plot/03_UMAPCluster_resolutions_V5.pdf",width = 20,height = 15)
...
ggsave("../out/test_introns/plot/03_UMAP_SCType_V5.pdf",width = 10,height = 7)

# save the annotated object -----------------------------------------------
saveRDS(scobj,"../out/test_introns/object/03_SCtypeAnnotation_V5.rds")
