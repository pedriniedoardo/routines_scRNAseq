...
cellranger count --id=test_neuron_token \
        ...
        --localcores=8 \
        --create-bam=false \
        --tenx-cloud-token-path=/mnt/SSD01/training/routines/scRNAseq/cellranger/test_annotation/data/token_10X_cloud.txt \
        --cell-annotation-model=auto \
        --localmem=64 \
        --output-dir=/mnt/SSD01/training/routines/scRNAseq/cellranger/test_annotation/out/cellranger901/test_neuron_token